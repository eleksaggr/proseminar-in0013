...
The figure \ref{mutability-refcell} shows how to construct such a \mintinline{rust}{RefCell} and how to borrow dynamically at runtime.
\begin{figure}
\begin{rustcode}
fn main() {
    let i = 32;
...
Appropiate here means when all fields of the type implement the \mintinline{rust}{Send} trait too.
