...
An example of this can be seen in figure \ref{unsafe-function}, in which a function called \mintinline{text}{add_three} takes a mutable raw pointer (see \ref{raw-pointer}), offsets it by one, deferences it, and adds three to it.
